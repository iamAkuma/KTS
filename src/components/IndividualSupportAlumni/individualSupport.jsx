    ...
    return (
        <>
            ...
            <div className={`alumni-container ${isLoading ? 'hidden' : 'visible'}`}>
                <Helmet>
                    <title>Certificate III in Individual Support Alumni - Kathmandu Technical School</title>
                </Helmet>
                <div className='alumni-section'>
                    <h1 className='alumni-header'>CERTIFICATE III IN INDIVIDUAL SUPPORT ALUMNI</h1>
